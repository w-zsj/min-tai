    ...
    <view class="main-wrapper">
      ...
      <view class="section">
          ...
          <view class="section-list" v-for="item in productList" :key="item.skuId">
            <view class="section-detail">
              ...
              <view class="section-detail-center flex-col-btwn">
                <view class="section-detail-title ellip-2">{{ item.productName }}</view>
        ...
        <view class="section-item section-deliver">
          <view class="section-item-title">是否使用嗨币</view>
          <view class="section-item-right">
            <span>{{ !coin ? "不可用" : "" }}</span>
            <switch color="#EC0D0D" :disabled="!coin" @change="changeCoinStatus" style="transform: scale(0.7)" />
          </view>
        </view>
        <view class="_line"></view>
        <view class="section-item section-total">
          <view class="section-item-title">配送费</view>
          <view class="section-item-remark-detail">
